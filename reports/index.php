...
$d="C:/xampp/htdocs/northwind/"; //eg: /home/user/html_public/myproj/"
require_once("$d/admin/incCommon.php");
   ...
   if(!$mi['username'] || $mi['username'] == 'guest'){
      ...
      echo '<script language="javaScript">setInterval("window.location=\'/C:/xampp/htdocs/northwind/index.php?signOut=1\'", 2000);</script>';
      exit;
   }
