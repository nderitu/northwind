<?php
	...
	if($thisMD5==$prevMD5){
		...
		setupTable('logs', "create table if not exists `logs` (   `Id` INT unsigned not null auto_increment , primary key (`Id`), `ip` VARCHAR(16) , `ts` BIGINT , `Details` TEXT ) CHARSET latin1", $silent, array( "ALTER TABLE `table9` RENAME `logs`","UPDATE `membership_userrecords` SET `tableName`='logs' where `tableName`='table9'","UPDATE `membership_userpermissions` SET `tableName`='logs' where `tableName`='table9'","UPDATE `membership_grouppermissions` SET `tableName`='logs' where `tableName`='table9'","ALTER TABLE logs ADD `field1` VARCHAR(40)","ALTER TABLE `logs` CHANGE `field1` `field1` VARCHAR(40) not null ","ALTER TABLE logs ADD `field2` VARCHAR(40)","ALTER TABLE `logs` DROP `field1`","ALTER TABLE `logs` DROP `field2`","ALTER TABLE logs ADD `field1` VARCHAR(40)","ALTER TABLE `logs` CHANGE `field1` `Id` VARCHAR(40) ","ALTER TABLE `logs` CHANGE `Id` `Id` INT unsigned not null auto_increment ","ALTER TABLE logs ADD `field2` VARCHAR(40)","ALTER TABLE `logs` CHANGE `field2` `Ip` VARCHAR(40) ","ALTER TABLE `logs` DROP `Ip`","ALTER TABLE logs ADD `field2` VARCHAR(40)","ALTER TABLE `logs` CHANGE `field2` `ip` VARCHAR(40) "," ALTER TABLE `logs` CHANGE `ip` `ip` VARCHAR(16) ","ALTER TABLE logs ADD `field3` VARCHAR(40)","ALTER TABLE `logs` CHANGE `field3` `ts` VARCHAR(40) "," ALTER TABLE `logs` CHANGE `ts` `ts` BIGINT ","ALTER TABLE logs ADD `field4` VARCHAR(40)","ALTER TABLE `logs` CHANGE `field4` `Details` VARCHAR(40) ","ALTER TABLE `logs` CHANGE `comments` `comments` TEXT ","ALTER TABLE `logs` ADD PRIMARY KEY (`Id`)"));
